...
def attack(char_name: str, char_class: str) -> str:
    """Эта функция вычисляет наносимый рандомный уров.
    Противнику в зависимости от класса героя.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Эта функция вычисляет рандомное заблокирование.
    Количестов урона  в зависимости от класса героя.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Эта функция вычисляет изминение определнного параметра от.
    Применинения специльного умения в зависимости от класса героя.
    """
    if char_class == 'warrior':
...
def start_training(
    ...
    """Эта функция помогает пройти обучение.
    В зависимости от выброного героя.
    """
    if char_class == 'warrior':
    ...
    print('Введи одну из команд: attack —'
          'чтобы атаковать противника, defence — чтобы'
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        ...
        approve_choice = input('Нажми (Y),'
                               'чтобы подтвердить выбор, или любую'
                               'другую кнопку,'
